...
//     songHistory: List<NowPlaying>.from(json["song_history"].map((x) => NowPlaying.fromJson(x))),
...
//     // playlists: playlistValues.map![json["playlists"]],
...
//     "played_at": playedAt,
//     "duration": duration,
//     // "playlists": playlistValues.reverse![playlists],
//     "streamer": streamer,
...
// enum Playlists { A_RAVE_LINK_C_LIST, A_RAVE_LINK_A_LIST, A_RAVE_LINK_B_LIST }
//
// final playlistValues = EnumValues({
//   "A-RaveLink - A  List": Playlists.A_RAVE_LINK_A_LIST,
//   "A-RaveLink - B List": Playlists.A_RAVE_LINK_B_LIST,
//   "A-RaveLink - C List": Playlists.A_RAVE_LINK_C_LIST
// });
//
// class Song {
//   Song({
